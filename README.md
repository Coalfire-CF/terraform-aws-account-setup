...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_additional_kms_keys"></a> [additional\_kms\_keys](#module\_additional\_kms\_keys) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_backup_kms_key"></a> [backup\_kms\_key](#module\_backup\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_cloudwatch_kms_key"></a> [cloudwatch\_kms\_key](#module\_cloudwatch\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_config_kms_key"></a> [config\_kms\_key](#module\_config\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_default_kms_key"></a> [default\_kms\_key](#module\_default\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_ebs_kms_key"></a> [ebs\_kms\_key](#module\_ebs\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_ecr_kms_key"></a> [ecr\_kms\_key](#module\_ecr\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_lambda_kms_key"></a> [lambda\_kms\_key](#module\_lambda\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_nfw_kms_key"></a> [nfw\_kms\_key](#module\_nfw\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_rds_kms_key"></a> [rds\_kms\_key](#module\_rds\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_s3-accesslogs"></a> [s3-accesslogs](#module\_s3-accesslogs) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-backups"></a> [s3-backups](#module\_s3-backups) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-cloudtrail"></a> [s3-cloudtrail](#module\_s3-cloudtrail) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-config"></a> [s3-config](#module\_s3-config) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-elb-accesslogs"></a> [s3-elb-accesslogs](#module\_s3-elb-accesslogs) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-fedrampdoc"></a> [s3-fedrampdoc](#module\_s3-fedrampdoc) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3-installs"></a> [s3-installs](#module\_s3-installs) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3_config_conformance_pack"></a> [s3\_config\_conformance\_pack](#module\_s3\_config\_conformance\_pack) | git::https://github.com/Coalfire-CF/terraform-aws-s3 | resource-naming-cleanup |
| <a name="module_s3_kms_key"></a> [s3\_kms\_key](#module\_s3\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_security-core"></a> [security-core](#module\_security-core) | git::https://github.com/Coalfire-CF/terraform-aws-securitycore | v0.1.0 |
| <a name="module_sm_kms_key"></a> [sm\_kms\_key](#module\_sm\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_sns_kms_key"></a> [sns\_kms\_key](#module\_sns\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
| <a name="module_sqs_kms_key"></a> [sqs\_kms\_key](#module\_sqs\_kms\_key) | git::https://github.com/Coalfire-CF/terraform-aws-kms | v1.0.1 |
...
| [aws_iam_policy_document.s3_config_conformance_pack_bucket_policy_doc](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_accesslogs_bucket_name"></a> [accesslogs\_bucket\_name](#input\_accesslogs\_bucket\_name) | (Optional) custom name for the access logs S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
...
| <a name="input_backups_bucket_name"></a> [backups\_bucket\_name](#input\_backups\_bucket\_name) | (Optional) custom name for the backups S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_cloudtrail_bucket_name"></a> [cloudtrail\_bucket\_name](#input\_cloudtrail\_bucket\_name) | (Optional) custom name for the Cloudtrail S3 Bucket; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_cloudtrail_iam_role_name"></a> [cloudtrail\_iam\_role\_name](#input\_cloudtrail\_iam\_role\_name) | (Optional) custom name for the Cloudtrail to Cloudwatch IAM role; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_cloudtrail_log_group_name"></a> [cloudtrail\_log\_group\_name](#input\_cloudtrail\_log\_group\_name) | (Optional) custom name for the Cloudtrail log group in Cloudwatch; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_cloudtrail_name"></a> [cloudtrail\_name](#input\_cloudtrail\_name) | (Optional) custom name for the Cloudtrail resource; if left undefined, a default name is created | `string` | `null` | no |
...
| <a name="input_config_bucket_name"></a> [config\_bucket\_name](#input\_config\_bucket\_name) | (Optional) custom name for the configuration S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_config_cross_account_ids"></a> [config\_cross\_account\_ids](#input\_config\_cross\_account\_ids) | AWS account IDs allowed cross-account access to the Config bucket | `list(string)` | n/a | yes |
...
| <a name="input_elb_accesslogs_bucket_name"></a> [elb\_accesslogs\_bucket\_name](#input\_elb\_accesslogs\_bucket\_name) | (Optional) custom name for the ELB access logs S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_fedrampdoc_bucket_name"></a> [fedrampdoc\_bucket\_name](#input\_fedrampdoc\_bucket\_name) | (Optional) custom name for the FedRAMP docs S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_installs_bucket_name"></a> [installs\_bucket\_name](#input\_installs\_bucket\_name) | (Optional) custom name for the installs S3 bucket; if left undefined, a default name is created | `string` | `null` | no |
...
| <a name="input_packer_ebs_kmsgrant_name"></a> [packer\_ebs\_kmsgrant\_name](#input\_packer\_ebs\_kmsgrant\_name) | (Optional) custom name for the KMS grant allowing Packer to access the EBS KMS key; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_packer_iam_instanceprofile_name"></a> [packer\_iam\_instanceprofile\_name](#input\_packer\_iam\_instanceprofile\_name) | (Optional) custom name for the Packer IAM instance profile; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_packer_iam_policy_name"></a> [packer\_iam\_policy\_name](#input\_packer\_iam\_policy\_name) | (Optional) custom name for the Packer IAM policy; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_packer_iam_role_name"></a> [packer\_iam\_role\_name](#input\_packer\_iam\_role\_name) | (Optional) custom name for the Packer IAM role; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_packer_s3_kmsgrant_name"></a> [packer\_s3\_kmsgrant\_name](#input\_packer\_s3\_kmsgrant\_name) | (Optional) custom name for the KMS grant allowing Packer to access the S3 bucket KMS key; if left undefined, a default name is created | `string` | `null` | no |
| <a name="input_resource_prefix"></a> [resource\_prefix](#input\_resource\_prefix) | The prefix for resources | `string` | n/a | yes |
| <a name="input_s3_backup_policy"></a> [s3\_backup\_policy](#input\_s3\_backup\_policy) | S3 backup policy to use for S3 buckets in conjunction with AWS Backups, should match an existing policy | `string` | `"aws-backup-minimum-compliance"` | no |
| <a name="input_s3_backup_settings"></a> [s3\_backup\_settings](#input\_s3\_backup\_settings) | Map of S3 bucket types to their backup settings | <pre>map(object({<br/>    enable_backup = bool<br/>  }))</pre> | <pre>{<br/>  "accesslogs": {<br/>    "enable_backup": false<br/>  },<br/>  "backups": {<br/>    "enable_backup": true<br/>  },<br/>  "cloudtrail": {<br/>    "enable_backup": false<br/>  },<br/>  "config": {<br/>    "enable_backup": true<br/>  },<br/>  "config-conformance": {<br/>    "enable_backup": true<br/>  },<br/>  "elb-accesslogs": {<br/>    "enable_backup": false<br/>  },<br/>  "fedrampdoc": {<br/>    "enable_backup": true<br/>  },<br/>  "installs": {<br/>    "enable_backup": true<br/>  }<br/>}</pre> | no |
