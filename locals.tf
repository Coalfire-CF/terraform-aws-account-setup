locals {
  ...
  cloudtrail_bucket_name          = var.cloudtrail_bucket_name != null ? var.cloudtrail_bucket_name : "${var.resource_prefix}-${var.aws_region}-cloudtrail"
  ...
  accesslogs_bucket_name          = var.accesslogs_bucket_name != null ? var.accesslogs_bucket_name : "${var.resource_prefix}-${var.aws_region}-s3-accesslogs"
  config_bucket_name              = var.config_bucket_name != null ? var.config_bucket_name : "${var.resource_prefix}-${var.aws_region}-config"
  backups_bucket_name             = var.backups_bucket_name != null ? var.backups_bucket_name : "${var.resource_prefix}-${var.aws_region}-backups"
  elb_accesslogs_bucket_name      = var.elb_accesslogs_bucket_name != null ? var.elb_accesslogs_bucket_name : "${var.resource_prefix}-${var.aws_region}-elb-accesslogs"
  fedrampdoc_bucket_name          = var.fedrampdoc_bucket_name != null ? var.fedrampdoc_bucket_name : "${var.resource_prefix}-${var.aws_region}-fedrampdoc"
  installs_bucket_name            = var.installs_bucket_name != null ? var.installs_bucket_name : "${var.resource_prefix}-${var.aws_region}-installs"
}
